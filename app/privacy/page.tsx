      ...
      <section className="relative pt-32 pb-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mt-6 text-lg text-white/70 leading-relaxed max-w-2xl">
            Your privacy matters. The full policy is being finalized with our legal counsel.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="rounded-2xl bg-white/[0.06] border border-white/10 p-5 sm:p-8 lg:p-12">
            ...
            <p className="text-[15px] text-white/75 leading-relaxed">
              The updated Privacy Policy for RegenCompliance, operated by Regen Portal LLC, is being finalized with our legal counsel and will be posted here shortly. For questions in the meantime, please use our{" "}
