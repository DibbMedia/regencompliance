        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/pricing" className="text-[13px] text-white hover:text-white transition-colors font-medium">Pricing</Link>
          ...
          {mobileMenu && (
            <div className="md:hidden border-t border-white/10 py-4 space-y-1">
              ...
              <Link href="/pricing" className="block text-sm text-white font-medium py-2.5 px-2 rounded-lg bg-white/5">Pricing</Link>
