        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/features" className="text-[13px] text-white hover:text-white transition-colors font-medium">Features</Link>
          ...
          {mobileMenu && (
            <div className="md:hidden border-t border-white/10 py-4 space-y-1">
              <Link href="/features" className="block text-sm text-white font-medium py-2.5 px-2 rounded-lg bg-white/5">Features</Link>
              ...
              <Link href="/faq" className="block text-sm text-white/60 hover:text-white py-2.5 px-2 rounded-lg hover:bg-white/5">FAQ</Link>
