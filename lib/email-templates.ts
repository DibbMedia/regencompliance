  ...
  return {
    ...
    html: layout(`
      ...
      <p style="margin:0 0 8px 0;font-size:15px;color:rgba(255,255,255,0.7);line-height:1.6;">
        <strong style="color:#55E039;">${clinicName}</strong> now has beta access to RegenCompliance at the locked-in rate of $297/mo. Your rate is locked at $297/mo for life - it will never increase, even when the standard plan goes to $497/mo.
      </p>
      <p style="margin:0 0 16px 0;font-size:15px;color:rgba(255,255,255,0.7);line-height:1.6;">
