...
export default function Body() {
  return (
    <>
      <Lead>
        GLP-1 brand names &mdash; Ozempic, Wegovy, Mounjaro, Zepbound
        &mdash; have become cultural shorthand for weight loss. Every
      ...
      <UL>
        ...
        <LI>
          ...
          FDA-approved &mdash; compounded preparations are distinct
      ...
      <P>
        Marketing Ozempic or Mounjaro as weight-loss drugs &mdash; when
        their FDA-approved indications are type 2 diabetes &mdash; is
      ...
      <P>
        ...
        requires fair balance &mdash; risk information presented with
      ...
      <P>
        ...
        brand-name products &mdash; &ldquo;same as Ozempic,&rdquo;
        &ldquo;identical active ingredient as Wegovy&rdquo; &mdash; is
      ...
      <P>
        ...
        should use generic language &mdash; &ldquo;GLP-1
      ...
      <P>
        ...
        belong on these pages &mdash; not hidden in a linked consent
        form.
      </P>
      ...
      <P>
        Compounded preparations can be discussed &mdash; they just need
      ...
      <P>
        ...
        options &mdash; including GLP-1 medications if appropriate
        &mdash; may be right for you.&rdquo;
      </P>
      ...
      <Callout variant="success" title="The insight: brand abstraction actually converts">
        ...
        that rank for weight-loss terms &mdash; they just don&rsquo;t
      ...
      <P>
        ...
        contexts &mdash; ads, social captions, landing page headlines,
        discount promotions &mdash; where brand names trigger the
        advertising rules.
      </P>
      ...
      <P>
        ...
        gap &mdash; it&rsquo;s a factual misrepresentation. Compounded
      ...
      <P>
        ...
        Fair balance requires comparable prominence &mdash; not
